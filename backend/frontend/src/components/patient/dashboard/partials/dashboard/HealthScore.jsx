...
const HealthScore = ({patientEmail}) => {
    ...
    const handleSubmit = async () => {
        const response = await fetch('https://flask-api-rw0z.onrender.com/predict', {
            method: 'POST',
        ...
        setResult(data);
        try {
            const historyResponse = await axios.post(`${window.location.origin}/patient/healthscore/${patientEmail}`, {
