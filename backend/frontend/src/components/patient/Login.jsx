...
export default function Login() {
  ...
  if (localStorage.getItem("sessionKey")) {
    axios.post(`${window.location.origin}/patient/session`, { "email": localStorage.getItem("email"), "sessionKey": localStorage.getItem("sessionKey") }).then(res => {
  ...
  function handleLogin(event) {
    axios.post(`${window.location.origin}/patient/login`, { "email": event.target.email.value, "password": event.target.password.value }).then(res => {
      if (res.data.status === "authenticated") {
        navigate("/patient/dashboard", { state: res.data.data });
        localStorage.setItem("currentPage", "Basic");
