...
function FirstPage(props) {
  ...
  function handleNext(event) {
    if (event.target.password.value === event.target.confirmPassword.value) {
      axios.post(`${window.location.origin}/patient/register`, { email: event.target.email.value, password: event.target.password.value }).then(res => {
...
function SecondPage(props) {
  ...
  event.preventDefault();
    axios.post(`${window.location.origin}/patient/profile`, data).then(res => {
