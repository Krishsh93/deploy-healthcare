...
function FirstPage(props) {
  ...
  function handleNext(event) {
    if (event.target.password.value === event.target.confirmPassword.value) {
      axios.post(`${window.location.origin}/doctor/register`, { email: event.target.email.value, password: event.target.password.value }).then(res => {
...
function SecondPage(props) {
  ...
  function handleSave(event) {
    ...
    event.preventDefault();
    axios.post(`${window.location.origin}/doctor/profile`, data).then(res => {
