...
export default function Login() {
  ...
  if (localStorage.getItem("sessionKey")) {
    axios.post(`${window.location.origin}/doctor/session`, { "email": localStorage.getItem("email"), "sessionKey": localStorage.getItem("sessionKey") }).then(res => {
  ...
  function handleLogin(event) {
    axios.post(`${window.location.origin}/doctor/login`, { "email": event.target.email.value, "password": event.target.password.value }).then(res => {
      if (res.data.status === "authenticated") {
        navigate("/doctor/dashboard", { state: res.data.data });
        localStorage.setItem("currentPage", "Basic");
